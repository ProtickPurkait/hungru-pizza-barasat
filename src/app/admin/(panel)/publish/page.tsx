    ...
    <>
      ...
      <div className="flex flex-col gap-6">
        <Notice tone="info" title="How it works">
          1. Edit and <strong>save</strong> anything in the admin. 2. Tap <strong>Preview</strong> to see the website with your changes (only you can see it).
          3. Tap <strong>Publish</strong> to make it live for everyone. Out-of-stock switches and “Pause online orders” are the exception: they go live instantly.
        </Notice>
        <PublishPanel
        ...
        />
        <Card title="Tip">
          <p className="text-sm text-stone-600">Made a mistake? Restore any earlier version below. Your drafts in the admin aren&apos;t changed by restoring.</p>
        </Card>
      </div>
    </>
  );
