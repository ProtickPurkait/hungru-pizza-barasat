  ...
  categories: [
    {
      name: "Pizzas",
      products: [
        { name: "Margherita", description: "Tomato sauce, loads of mozzarella, oregano.", price: 199, diet: "veg", isBestseller: true, options: pizzaOptions() },
        { name: "Farmhouse", description: "Onion, capsicum, mushroom and sweet corn.", price: 299, discountPrice: 259, diet: "veg", isBestseller: true, badge: "Hot deal", options: pizzaOptions() },
        { name: "Paneer Tikka", description: "Tandoori paneer, onion, capsicum, mint mayo drizzle.", price: 329, diet: "veg", isBestseller: true, badge: "Spicy", options: pizzaOptions() },
        { name: "Veg Supreme", description: "Olives, jalapeño, onion, capsicum, corn and mushroom.", price: 349, diet: "veg", options: pizzaOptions() },
        { name: "Chicken Tikka", description: "Smoky chicken tikka, onion and capsicum.", price: 379, diet: "non_veg", isBestseller: true, options: pizzaOptions() },
    ...
    },
    {
      name: "Combos",
      products: [
        { name: "Duo Combo", description: "Any two regular pizzas with garlic bread.", price: 549, diet: "veg" },
      ],
    },
    {
      name: "Sides",
