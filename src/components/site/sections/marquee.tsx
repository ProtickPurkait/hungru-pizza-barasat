    ...
    <div className={className} aria-hidden>
      <div
        ...
        style={{
          ...
          ["--marquee-duration" as string]: `${Math.max(18, words.length * 2.2)}s`,
        }}
      >
        {[0, 1].map((copy) => (
  ...
  return (
    <section className="relative overflow-hidden bg-cream pt-8 pb-16 sm:pt-12 sm:pb-24">
      ...
      <Band
        words={words}
        reverse
        className="absolute inset-x-0 top-[46%] -mx-6 rotate-[3.5deg] bg-accent text-ink ring-2 ring-ink sm:top-[44%]"
      />
      <Band
        words={words}
        className="relative z-10 -mx-6 -rotate-2 bg-primary text-cream ring-2 ring-ink shadow-[0_10px_0_0_rgb(20_17_16/0.12)]"
      />
    </section>
  );
}
